	...
	<div class="row">
		<div class="col-md-4">
		  <div class="form-group mt-5">
		      ...
		      <div class="form-control-wrap">
		          <input type="text" class="form-control form-control-lg" placeholder="{{ __('ex: 10') }}" name="month">
		      </div>
		  </div>
		</div>
		<div class="col-md-4">
		...
		<div class="col-md-4">
		  <div class="form-group mt-5">
		      ...
		      <div class="form-control-wrap">
		          <input type="text" class="form-control form-control-lg" placeholder="{{ __('ex: 30') }}" name="annual">
		      </div>
		  </div>
		</div>
	</div>
    ...
    <div class="row">
    	...
    	<div class="col-12 col-md-4 mt-5">
    		<div class="custom-control custom-checkbox custom-control-lg">
			    ...
			    <input type="checkbox" class="custom-control-input" id="add_to_head" name="add_to_head" value="1">
