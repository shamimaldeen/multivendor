...
<form action="{{ route('edit.post.package', $package->id) }}" method="post">
	...
	<div class="row">
		<div class="col-md-4">
		  <div class="form-group mt-5">
		      ...
		      <div class="form-control-wrap">
		          <input type="text" class="form-control form-control-lg" placeholder="{{ __('ex: 10') }}" name="month" value="{{ $package->price->month ?? '' }}">
		      </div>
		  </div>
		</div>
		<div class="col-md-4">
		  <div class="form-group mt-5">
		      ...
		      <div class="form-control-wrap">
		          <input type="text" class="form-control form-control-lg" placeholder="{{ __('ex: 20') }}" name="quarter" value="{{ $package->price->quarter ?? '' }}">
		      </div>
		  </div>
		</div>
		<div class="col-md-4">
		  <div class="form-group mt-5">
		      ...
		      <div class="form-control-wrap">
		          <input type="text" class="form-control form-control-lg" placeholder="{{ __('ex: 30') }}" name="annual" value="{{ $package->price->annual ?? '' }}">
		      </div>
		  </div>
		</div>
	</div>
    ...
    <div class="row">
    	...
    	<div class="col-12 col-md-4 mt-5">
    		<div class="custom-control custom-checkbox custom-control-lg">
			    <input type="hidden" class="custom-control-input" name="add_to_head" value="0">
			    <input type="checkbox" class="custom-control-input" id="add_to_head" name="add_to_head" value="1" {{ (!empty($package->settings->add_to_head) && ($package->settings->add_to_head)) ? "checked" : "" }}>
			    <label class="custom-control-label" for="add_to_head">{{ __('Add to Head Script') }} | </label>
			</div>
			<label class="mt-2">{{ __('Users on this plan gets to add script to head') }}</label>
    	</div>
    	<div class="col-12 col-md-4 mt-5">
    		<div class="custom-control custom-checkbox custom-control-lg">
