                                ...
                                <div class="invoice-card">
                                    ...
                                    <div class="invoice-section is-flex is-bordered">
                                      @if (!empty($customer))
                                        ...
                                        @endif
                                        <div class="meta">
                                            <h3>{{ $order->details->{'first_name'} ?? '' }} {{ $order->details->last_name ?? '' }}</h3>
                                    ...
                                    <div class="invoice-section">
                                        ...
                                        <div class="flex-table sub-table">
                                            ...
                                            <div class="flex-table-item shadow-none">
                                                ...
                                                <div class="flex-table-cell has-text-right" data-th="">
                                                    <span class="table-total dark-inverted">{!! Currency::symbol(user('gateway.currency')) !!}{{ nf($prices) }}</span>
                                                </div>
                                            </div>
                                            <!--Table item-->
                                            <div class="flex-table-item shadow-none">
                                                ...
                                                <div class="flex-table-cell has-text-right" data-th="">
                                                    <span class="table-total is-bigger dark-inverted">{!! Currency::symbol(user('gateway.currency')) !!}{{ nf($total_price) }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
