                            ...
                            <div class="invoice-header px-3">
                                ...
                                <div class="right">
                                    <div class="controls">
                                        ...
                                        <a href="Javascript::void" class="action html-to-canvas-download" data-html=".invoice-body" data-name="invoice">
                            ...
                            <div class="invoice-body card border-0 radius-5">
                                <div class="invoice-card">
                                    <div class="invoice-section is-flex is-bordered">
                                        ...
                                        <div class="end">
                                            <h3>{{ __('Invoice') }}: {{ $invoice->ref }}</h3>
                                            <span>{{ __('Issued on') }}: {{ Carbon\Carbon::parse($invoice->date)->toFormattedDateString() }}</span>
                                            <span>{{ __('By') }}: {{$invoice->name}}</span>
                                        </div>
                                    </div>
                                    <div class="invoice-section is-flex is-bordered">
                                        ...
                                        <div class="meta">
                                          <small>{{ __('Name') }} - {{$invoice->name}}</small>
                                    ...
                                    <div class="invoice-section">
                                                     ...
                                                     <div class="flex-table-item">
                                                         <div class="flex-table-cell is-media" data-th="">
                                                             <div class="h-avatar is-medium">
                                                                 <img class="avatar is-squared h-40px object-cover" src=" " alt=" ">
                                                             </div>
                                                             <div>
                                                                 <span class="item-name dark-inverted fs-11px">{{$invoice->package_name}}</span>
                                                             </div>
                                                         </div>
                                                         ...
                                                         <div class="flex-table-cell" data-th="{{ __('Price') }}">
                                                             <span class="tag fs-11px">{{ nf($invoice->price) }}</span>
                                                         </div>
                                                         <div class="flex-table-cell" data-th="{{ __('Duration') }}">
                                                             <span class="tag fs-11px">{{ $invoice->duration }}</span>
                                                         </div>
                                        ...
                                        <div class="flex-table sub-table">
                                            ...
                                            <div class="flex-table-item shadow-none">
                                                ...
                                                <div class="flex-table-cell has-text-right" data-th="">
                                                    <span class="table-total dark-inverted">{!! Currency::symbol(settings('currency')) !!}{{ nf($invoice->price) }}</span>
                                                </div>
                                            </div>
                                            <!--Table item-->
                                            <div class="flex-table-item shadow-none">
                                                ...
                                                <div class="flex-table-cell has-text-right" data-th="">
                                                    <span class="table-total is-bigger dark-inverted">{!! Currency::symbol(settings('currency')) !!}{{ nf($invoice->price) }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
