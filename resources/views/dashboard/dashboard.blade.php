    ...
    <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 xl:col-span-8 mt-6">
            ...
            <div class="intro-y box p-5 mt-12 sm:mt-5">
                ...
                <div class="report-maps mt-5 bg-gray-200 rounded-md" data-center="-6.2425342, 106.8626478" data-sources="{{ url('backend/dist/json/location.json') }}"></div>
            </div>
        </div>
        <!-- END: Official Store -->
        ...
        <div class="col-span-12 xl:col-span-4 mt-6">
            ...
            <div class="mt-5">
                <div class="intro-y">
                    <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                        <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                            <img alt="Midone Tailwind HTML Admin Template" src="{{ url ('backend/dist/images/profile-4.jpg') }}">
                        </div>
                ...
                <div class="intro-y">
                    <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                        <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                            <img alt="Midone Tailwind HTML Admin Template" src="{{ url ('backend/dist/images/profile-14.jpg') }}">
                        </div>
                        <div class="ml-4 mr-auto">
                ...
                <div class="intro-y">
                    <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                        <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                            <img alt="Midone Tailwind HTML Admin Template" src="{{ url ('backend/dist/images/profile-6.jpg') }}">
                        </div>
                        <div class="ml-4 mr-auto">
                ...
                <table class="table table-report sm:mt-2">
                        ...
                        <td class="w-40">
                            <div class="flex">
                                <div class="w-10 h-10 image-fit zoom-in">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ url ('backend/dist/images/preview-7.jpg') }}" title="Uploaded at 2 December 2021">
                                </div>
                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ url ('backend/dist/images/preview-4.jpg') }}" title="Uploaded at 23 May 2020">
                                </div>
                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ url ('backend/dist/images/preview-3.jpg') }}" title="Uploaded at 17 November 2021">
                                </div>
                            </div>
                        </td>
                        <td>
                    ...
                    <tr class="intro-x">
                        <td class="w-40">
                            <div class="flex">
                                <div class="w-10 h-10 image-fit zoom-in">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ url ('backend/dist/images/preview-4.jpg') }}" title="Uploaded at 21 July 2022">
                                </div>
                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ url ('backend/dist/images/preview-13.jpg') }}" title="Uploaded at 25 June 2021">
                                </div>
                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ url ('backend/dist/images/preview-6.jpg') }}" title="Uploaded at 19 October 2022">
                                </div>
                            </div>
                        </td>
                        <td>
                    ...
                    <tr class="intro-x">
                        <td class="w-40">
                            <div class="flex">
                                <div class="w-10 h-10 image-fit zoom-in">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ url ('backend/dist/images/preview-3.jpg') }}" title="Uploaded at 22 June 2021">
                                </div>
                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ url ('backend/dist/images/preview-3.jpg') }}" title="Uploaded at 22 April 2022">
                                </div>
                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ url ('backend/dist/images/preview-10.jpg') }}" title="Uploaded at 6 September 2022">
                                </div>
                            </div>
                        </td>
                        <td>
                    ...
                    <tr class="intro-x">
                        <td class="w-40">
                            <div class="flex">
                                <div class="w-10 h-10 image-fit zoom-in">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ url ('backend/dist/images/preview-11.jpg') }}" title="Uploaded at 30 March 2022">
                                </div>
                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ url ('backend/dist/images/preview-14.jpg') }}" title="Uploaded at 2 October 2021">
                                </div>
                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ url ('backend/dist/images/preview-11.jpg') }}" title="Uploaded at 6 November 2021">
                                </div>
                            </div>
                        </td>
                        <td>
            ...
            <div class="col-span-12 md:col-span-6 xl:col-span-4 xxl:col-span-12 mt-3 xxl:mt-8">
                ...
                <div class="mt-5">
                    ...
                    <div class="intro-x">
                        <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                            <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                <img alt="Midone Tailwind HTML Admin Template" src="{{ url ('backend/dist/images/profile-2.jpg') }}">
                            </div>
                            <div class="ml-4 mr-auto">
            ...
            <div class="col-span-12 md:col-span-6 xl:col-span-4 xxl:col-span-12 mt-3">
                ...
                <div class="report-timeline mt-5 relative">
                    ...
                    <div class="intro-x relative flex items-center mb-3">
                        <div class="report-timeline__image">
                            <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                <img alt="Midone Tailwind HTML Admin Template" src="{{ url ('backend/dist/images/profile-13.jpg') }}">
                            </div>
                        </div>
                        <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                            <div class="flex items-center">
                            ...
                            <div class="text-gray-600">
                                ...
                                <div class="flex mt-2">
                                    <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Nike Tanjun">
                                        <img alt="Midone Tailwind HTML Admin Template" class="rounded-md border border-white" src="{{ url ('backend/dist/images/preview-10.jpg') }}">
                                    </div>
                                    <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Apple MacBook Pro 13">
                                        <img alt="Midone Tailwind HTML Admin Template" class="rounded-md border border-white" src="{{ url ('backend/dist/images/preview-1.jpg') }}">
                                    </div>
                                    <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Sony Master Series A9G">
                                        <img alt="Midone Tailwind HTML Admin Template" class="rounded-md border border-white" src="{{ url ('backend/dist/images/preview-15.jpg') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="intro-x relative flex items-center mb-3">
                        <div class="report-timeline__image">
                            <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                <img alt="Midone Tailwind HTML Admin Template" src="{{ url ('backend/dist/images/profile-3.jpg') }}">
                            </div>
                        </div>
                        <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                            <div class="flex items-center">
                    ...
                    <div class="intro-x relative flex items-center mb-3">
                        <div class="report-timeline__image">
                            <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                <img alt="Midone Tailwind HTML Admin Template" src="{{ url ('backend/dist/images/profile-11.jpg') }}">
                            </div>
                        </div>
                        <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                            <div class="flex items-center">
