            ...
            <div class="data-head mb-4 mt-5">
             ...
             <div class="form-group">
               ...
               <div class="row mb-4">
                 <div class="col">
                   <div class="form-group">
                        <input id="first_name" class="form-control form-control-lg @error('first_name') is-invalid @enderror" type="text" placeholder="{{ __('Store Name') }}" name="first_name" value="{{ old('first_name') }}" autocomplete="first_name" autofocus/>
                      @error('first_name')
                          <span class="invalid-feedback d-block m-0" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
